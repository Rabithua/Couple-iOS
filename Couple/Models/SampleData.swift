...
enum SampleData {
    ...
    static let user = User(
        ...
        displayName: AppLocalization.string("程袭"),
        timezone: "Asia/Shanghai"
    )
    static let partner = CoupleMember(
        id: "10000000-0000-4000-8000-000000000002",
        displayName: AppLocalization.string("长野")
    )
    ...
    static let anniversary = Anniversary(
        ...
        ownerId: user.id,
        title: AppLocalization.string("程袭的生日"),
    ...
    static let todos: [Todo] = [
        AppLocalization.string("一起去灵隐寺还愿吧"),
        AppLocalization.string("闪击杭钢"),
        AppLocalization.string("真的很想吃云记烤鸭"),
        AppLocalization.string("清迈好啊，去玩去玩")
    ...
    static let notes: [Note] = [
        Note(
            ...
            coupleId: relationship.couple!.id,
            ownerId: partner.id,
            content: AppLocalization.string("遇到了特别特别特别好看的夕阳，美美拍照，还有特别棒的双彩虹！\n还见到了好久没见的小狗！\n（👇图一也是小狗哈）"),
            visibility: .shared,
            anniversaryId: nil,
            todoId: nil,
            latitude: 30.474,
            longitude: 120.012,
            locationName: AppLocalization.string("瓶窑镇良渚生长力聚落"),
        ...
        Note(
            ...
            coupleId: relationship.couple!.id,
            ownerId: user.id,
            content: AppLocalization.string("谁能拒绝坐在水边逮一下午虾呢～"),
            visibility: .shared,
            anniversaryId: nil,
            todoId: nil,
            latitude: 30.372,
            longitude: 120.178,
            locationName: AppLocalization.string("虎山公园&杭钢公园"),
    ...
    static let events: [CalendarEvent] = [
        CalendarEvent(
            ...
            coupleId: relationship.couple!.id,
            ownerId: user.id,
            title: AppLocalization.string("一起吃晚饭"),
            description: nil,
            allDay: false,
